...
```bash
# リポジトリをクローン
git clone https://github.com/poxcondev/POXCON-Official.git
cd POXCON-Official
...
# ブラウザで http://localhost:5173/POXCON-Official/ を開く
```
...
- GitHub: [@poxcondev](https://github.com/poxcondev)
- Website: [POXCON Official](https://poxcondev.github.io/POXCON-Official/)
